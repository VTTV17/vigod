...
public class LazadaProductElements {
    By loc_ckbSelectProduct(long productId){
        return By.xpath("//td[@title='%s']/preceding-sibling::td//label".formatted(productId));
    }
    ...
    By loc_icnDownloadProduct(String lazadaProductId){
