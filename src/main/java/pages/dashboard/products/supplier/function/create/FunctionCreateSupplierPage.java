...
import pages.dashboard.products.supplier.ui.create.UICreateSupplierPage;
...
public class FunctionCreateSupplierPage extends FunctionCreateSupplierElement {

    Logger logger = LogManager.getLogger(FunctionCreateSupplierPage.class);

    WebDriverWait wait;
    public String language;
    UICommonAction commonAction;
    Actions act;
    UICreateSupplierPage uiCreateSupplierPage;

    public FunctionCreateSupplierPage(WebDriver driver) {
        super(driver);
        wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        commonAction = new UICommonAction(driver);
        act = new Actions(driver);
        uiCreateSupplierPage = new UICreateSupplierPage(driver);
    }

    public FunctionCreateSupplierPage setLanguage(String language) {
    ...
    public void createNewSupplier(boolean isVNSupplier) throws Exception {
        ...
        // check UI
        uiCreateSupplierPage.checkUIAddSupplierPage(language, isVNSupplier);
        ...
        if (uiCreateSupplierPage.countFail > 0) {
            Assert.fail("[Failed] Fail %d cases".formatted(uiCreateSupplierPage.countFail));
        }
    }
}
