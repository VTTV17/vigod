...
public class FunctionSupplierManagementPage extends FunctionSupplierManagementElement {
	UICommonAction commons;
	WebDriverWait wait;
	String SUPPLIER_MANAGEMENT_PATH = "/supplier/list";

	final static Logger logger = LogManager.getLogger(FunctionSupplierManagementPage.class);

	public FunctionSupplierManagementPage(WebDriver driver) {
		super(driver);
		wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		commons = new UICommonAction(driver);
		PageFactory.initElements(driver, this);
	}
	public FunctionSupplierManagementPage inputSearchTerm(String searchTerm) {
