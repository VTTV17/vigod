...
public class ProductPageElement {
    ...
    By livePreviewTooltipsOnEditTranslationPopup = By.cssSelector("[aria-describedby = tippy-tooltip-19]");
    By seoTitleLabelOnEditTranslationPopup = By.xpath("//*[@aria-describedby='tippy-tooltip-20']/parent::div/preceding-sibling::span");
    By seoTitleTooltipsOnEditTranslationPopup = By.cssSelector("[aria-describedby='tippy-tooltip-20']");
    By seoDescriptionLabelOnEditTranslationPopup = By.xpath("//*[@aria-describedby='tippy-tooltip-21']/parent::div/preceding-sibling::span");
    By seoDescriptionTooltipsOnEditTranslationPopup = By.cssSelector("[aria-describedby='tippy-tooltip-21']");
    By seoKeywordsLabelOnEditTranslationPopup = By.xpath("//*[@aria-describedby='tippy-tooltip-22']/parent::div/preceding-sibling::span");
    By seoKeywordsTooltipsOnEditTranslationPopup = By.cssSelector("[aria-describedby='tippy-tooltip-22']");
