...
public class ProductPageRef extends ProductPageElementRef {
    WebDriverWait wait;
    Actions act;
    UICommonAction commonAction;
    String CREATE_PRODUCT_PATH = "/product/create";

    Logger logger = LogManager.getLogger(ProductPageRef.class);

    public ProductPageRef(WebDriver driver) {
        super(driver);
    ...
    public ProductPageRef navigateToCreateProductPage() {
