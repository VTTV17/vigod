...
public class EditProductElement {
    ...
    By loc_icnDeleteImages = androidUIAutomator(androidUIAutomatorResourcesIdString.formatted("%s:id/ivDelete".formatted(goSELLERBundleId)));
    ...
    By loc_lstVariations(int variationIndex)  {
        return androidUIAutomator(androidUIAutomatorResourcesIdInstanceString.formatted("%s:id/llVariationContainer".formatted(goSELLERBundleId), variationIndex));
    }
    ...
    By loc_dlgWarningManageByLot_btnOK = androidUIAutomator(androidUIAutomatorResourcesIdString.formatted("%s:id/tvRightButton".formatted(goSELLERBundleId)));
}
