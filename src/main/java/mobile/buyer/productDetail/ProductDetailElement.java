...
public class ProductDetailElement {
    ...
    By loc_lblProductName = By.xpath("//*[contains(@resource-id, 'item_market_product_detail_desc_title')]");
    By loc_lblFlashSaleBadge = By.xpath("//*[contains(@resource-id, 'llFlashSale')]");
    By loc_lblDiscountCampaignBadge = By.xpath("//*[contains(@resource-id, 'item_market_product_detail_tv_wholesale_label')]");
    By loc_lblWholesaleProductBadge = By.xpath("//*[contains(@resource-id, 'group_wholesale_pricing')]");
    By loc_lblSoldOutMark = By.xpath("//*[contains(@resource-id, 'activity_item_details_tv_not_available')]");
    String rsId_lblListingPrice = "%s:id/item_market_product_detail_desc_original_price".formatted(goBUYERBundleId);
    String rsId_lblSellingPrice = "%s:id/item_market_product_detail_desc_promotion_price".formatted(goBUYERBundleId);
    By loc_lblListingPrice = By.xpath("//*[contains(@resource-id, 'item_market_product_detail_desc_original_price')]");
    By loc_lblSellingPrice = By.xpath("//*[contains(@resource-id, 'item_market_product_detail_desc_promotion_price')]");
    ...
    String rsId_sctBranch = "%s:id/rv_branch".formatted(goBUYERBundleId);
    By loc_lblBranch(String branchName) {
        return By.xpath("//android.widget.TextView[contains(@text, \"%s\")]".formatted(branchName));
    }
    ...
    String rsId_sctDescription = "%s:id/activity_item_details_desc".formatted(goBUYERBundleId);
    By loc_lblDescriptionContent = By.xpath("(//*[@resource-id=\"%s:id/activity_item_details_desc\"]//android.widget.TextView)[2]".formatted(goBUYERBundleId));
