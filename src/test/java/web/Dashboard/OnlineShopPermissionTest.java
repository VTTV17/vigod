...
public class OnlineShopPermissionTest extends BaseTest{
...
//                {"1111111"}
    ...
    public void checkThemePermission(String binaryData){
        CreatePermission model = new CreatePermission();
        model.setHome_none("10");
        model.setOnlineStore_theme(binaryData);
        //edit permisison
        ...
        new Themes(driver).getLoginInfo(ownerCredentials).checkThemesPermission(allPermissions);
    }
    @DataProvider
    public Object[] BlogData(){
        return new Object[][]{
//                {"1"},
//                {"10"},
//                {"11"},
...
//                {"1111111111"}
    ...
    @Test(dataProvider = "BlogData")
    public void checkBlogPermission(String binaryData){
        CreatePermission model = new CreatePermission();
        model.setHome_none("10");
        model.setOnlineStore_blog(binaryData);
        //edit permisison
        new PermissionAPI(ownerCredentials).editGroupPermissionAndGetID(groupPermissionId, "Vi's Permission "+groupPermissionId, "Description Vi's Permission", model);
        //Get info of the staff after being granted the permission
        staffLoginInfo = new Login().getInfo(staffCredentials);
        //Get permission
        AllPermissions allPermissions = new AllPermissions(staffLoginInfo.getStaffPermissionToken());
        int articleId = new APIBlog(ownerCredentials).getArticleId();
