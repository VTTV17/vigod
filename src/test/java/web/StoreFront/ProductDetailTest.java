...
public class ProductDetailTest extends BaseTest {
    protected static LoginInformation loginInformation = new LoginInformation(ADMIN_ACCOUNT_THANG, ADMIN_PASSWORD_THANG);
    protected static List<Integer> branchID = new BranchManagement(loginInformation).getInfo().getBranchID();
    protected static int customerId = new APIAllCustomers(loginInformation).getCustomerID(BUYER_ACCOUNT_THANG);

    public static class NormalProductWithoutVariationTest extends BaseTest {
        WebDriver driver;
        int productId;
    ...
    public static class IMEIProductWithoutVariationTest extends BaseTest {
        WebDriver driver;
        int productId;
        ProductInfo productInfo;
        ProductDiscountCampaignConditions conditions;
    ...
    public static class NormalProductWithVariationTest extends BaseTest {
        WebDriver driver;
        int productId;
        ProductInfo productInfo;
        ProductDiscountCampaignConditions conditions;
    ...
    public static class IMEIProductWithVariationTest extends BaseTest {
        WebDriver driver;
        int productId;
        ProductInfo productInfo;
        ProductDiscountCampaignConditions conditions;
    ...
    static void waitFlashSaleStart() {
        try {
            sleep(60000);
