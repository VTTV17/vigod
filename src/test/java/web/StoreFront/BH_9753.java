...
public class BH_9753 extends BaseTest {
    ...
    void BH_9753_G1_Case1_1_OneBranchActiveAndHideBranchOnStoreFront() throws Exception {
        ...
        if (productID == 0) productID = new APICreateProduct(loginInformation).createWithoutVariationProduct(isIMEIProduct, stock).getProductID();
    ...
    void BH_9753_G3_Case1_1_OneBranchActiveAndHideBranchOnStoreFront() throws Exception {
        ...
        if (productID == 0) productID = new APICreateProduct(loginInformation).createVariationProduct(isIMEIProduct, increaseNum, stock).getProductID();
        productInfo = new APIProductDetail(loginInformation).getInfo(productID);
        new BranchManagement(loginInformation).hideFreeBranchOnShopOnline()
                .inactiveAllPaidBranches();
